...
vim.defer_fn(function()
    ...
    vim.keymap.set('n', 'ep', vim.diagnostic.goto_prev, { desc = 'Go to [p]revious diagnostic message' })
    vim.keymap.set('n', 'eN', vim.diagnostic.goto_prev, { desc = 'Go to previous diagnostic message' })
    vim.keymap.set('n', ']d', vim.diagnostic.goto_next, { desc = 'Go to next diagnostic message' })
    vim.keymap.set('n', 'en', vim.diagnostic.goto_next, { desc = 'Go to [n]ext diagnostic message' })
